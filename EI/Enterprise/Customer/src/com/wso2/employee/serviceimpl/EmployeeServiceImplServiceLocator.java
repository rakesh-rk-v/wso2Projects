...
public class EmployeeServiceImplServiceLocator extends org.apache.axis.client.Service implements com.wso2.employee.serviceimpl.EmployeeServiceImplService {
    ...
    private java.lang.String EmployeeServiceImpl_address = "http://localhost:8080/Employee/services/EmployeeServiceImpl";
    ...
    public com.wso2.employee.serviceimpl.EmployeeServiceImpl getEmployeeServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.wso2.employee.serviceimpl.EmployeeServiceImpl getEmployeeServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wso2.employee.serviceimpl.EmployeeServiceImplSoapBindingStub _stub = new com.wso2.employee.serviceimpl.EmployeeServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.wso2.employee.serviceimpl.EmployeeServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wso2.employee.serviceimpl.EmployeeServiceImplSoapBindingStub _stub = new com.wso2.employee.serviceimpl.EmployeeServiceImplSoapBindingStub(new java.net.URL(EmployeeServiceImpl_address), this);
                _stub.setPortName(getEmployeeServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://serviceimpl.employee.wso2.com", "EmployeeServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://serviceimpl.employee.wso2.com", "EmployeeServiceImpl"));
        }
