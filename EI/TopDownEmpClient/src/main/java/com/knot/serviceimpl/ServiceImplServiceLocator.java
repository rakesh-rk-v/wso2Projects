...
public class ServiceImplServiceLocator extends org.apache.axis.client.Service implements com.knot.serviceimpl.ServiceImplService {
    ...
    private java.lang.String ServiceImpl_address = "http://localhost:8080/TopDownEmp/services/ServiceImpl";
    ...
    public com.knot.serviceimpl.ServiceImpl getServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.knot.serviceimpl.ServiceImplSoapBindingStub _stub = new com.knot.serviceimpl.ServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.knot.serviceimpl.ServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.knot.serviceimpl.ServiceImplSoapBindingStub _stub = new com.knot.serviceimpl.ServiceImplSoapBindingStub(new java.net.URL(ServiceImpl_address), this);
                _stub.setPortName(getServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://serviceimpl.knot.com", "ServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://serviceimpl.knot.com", "ServiceImpl"));
        }
